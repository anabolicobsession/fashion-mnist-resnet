...
class Linear(Layer):
    ...
    def backward(self, dL_wrt_output):
        ...
        """
        self.dL_wrt_W = np.einsum('bi,bo->bio', self.x, dL_wrt_output)
        self.dL_wrt_b = np.expand_dims(dL_wrt_output, 1)
        return dL_wrt_output @ self.W.T
